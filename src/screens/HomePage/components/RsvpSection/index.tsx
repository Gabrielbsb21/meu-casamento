...
import shape1 from '/public/assets/images/rsvp/shape.svg';
import shape2 from '/public/assets/images/rsvp/shape2.svg';
import shape3 from '/public/assets/images/rsvp/shape3.svg';
import shape4 from '/public/assets/images/rsvp/shape4.svg';
import shape5 from '/public/assets/images/rsvp/shape5.svg';
import shape6 from '/public/assets/images/rsvp/shape6.svg';
import RSVPFrom from './RSVPFrom';
    ...
    <section className={`wpo-contact-section ${rClass} section-padding`} id='rsvp'>
      <div className="container mx-auto px-4">
        <div className="flex justify-center">
          <div className="flex flex-column lg:w-1/3 w-full">
            <div className="wpo-contact-section-wrapper w-full">
      ...
      <div className="bottom-bg">
        ...
        <div className="shape-3">
          <JackInTheBox  duration={3000} triggerOnce={true}>
        ...
        <div className="shape-5">
          <JackInTheBox  duration={3500} triggerOnce={true}>
            <Image src={shape5} alt="" />
          </JackInTheBox>
        </div>
        <div className="shape-6">
          <JackInTheBox  duration={4000} triggerOnce={true}>
